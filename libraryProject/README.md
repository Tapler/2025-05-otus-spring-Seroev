...
2. Запустите приложение:
   ```sh
   java -jar target/libraryProject-*.jar
   ```
...
> **Важно:** Для передачи списка id через запятую (например, author-ids) используйте кавычки:
> 
> Пример: `--author-ids "2,3"`
> 
> Без кавычек Spring Shell не сможет корректно распознать параметр.
